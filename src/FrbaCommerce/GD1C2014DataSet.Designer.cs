...
FROM         LOL.tl_Funcionalidades, LOL.tl_Roles_Funcionalidades
WHERE     tl_Funcionalidades.ID = LOL.tl_Roles_Funcionalidades.Funcionalidad_ID AND
...
SELECT Publicacion_Codigo, Rubro_ID FROM LOL.tl_Publicaciones_Rubros WHERE (Publicacion_Codigo = @Publicacion_Codigo) AND (Rubro_ID = @Rubro_ID)";
    ...
    public partial class tl_RolesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "LOL.sp_EliminarRol";
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int sp_EliminarRol(global::System.Nullable<int> rol) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((rol.HasValue == true)) {
                command.Parameters[1].Value = ((int)(rol.Value));
            }
            else {
...
SELECT Codigo, Descripcion, Precio, Porcentaje FROM LOL.tl_Visibilidades WHERE (Codigo = @Codigo)";
    ...
    public partial class QueriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            ((global::System.Data.SqlClient.SqlCommand)(this._commandCollection[0])).CommandText = "LOL.sp_EliminarRol";
